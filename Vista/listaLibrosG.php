<?php
include('../Controlador/librosGen.php');
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">Lista General de Libros</a></li>
...
<div class="row" style="padding-top: 60px;">
  <div class="col-sm-12">
          <div class="well">
           <p style="font-weight: bold; text-align: center; font-size: 30px;">Lista de libros: General</p>
          </div>
        </div>
</div>
<table border=2 width=100%>
  ...
  <tr>
    <td><input style='border-width: 0px;' type='text' readonly value='".$fila['numAdquisicion']."' name='adqui'/></td>
